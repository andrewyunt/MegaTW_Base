 ...
 */
package com.andrewyunt.megatw_base.command;
...
public class BloodToggleCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		try {
			gp = MegaTWBase.getInstance().getPlayers().get(sender.getName());
		} catch (NullPointerException e) {
			return false;
		}
		
		boolean hasBloodEffect = !gp.hasBloodEffect();
		
		gp.setBloodEffect(hasBloodEffect);
